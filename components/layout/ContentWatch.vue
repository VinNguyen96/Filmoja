            ...
            <div class="row watch-content " v-for="(item,index) in textArray" :key="text + index">
                <div class="col-lg-5 watch-text">
                    ...
                    <div class="discover ">
                        ...
                        <nuxt-link to="#" class="btn-discover">{{item.discover}}</nuxt-link>

                    </div>
                </div>
                <div class="col-lg-7 watch-video">
            ...
            textArray:[
                {
                    ...
                    h6: 'Researved Your Seat,Before You Miss Tomorrow',
                    discover:'Discover All',
                    img: require('@/assets/images/theater.jpeg')
                }
            ]
        }
    }
